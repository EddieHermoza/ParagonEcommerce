...
export default function LinearChart({ chartData, ticker }: InteractiveStockChartProps) {
    ...
    return (
        <>
            {isMobile ? (
                <Dialog>
                    <DialogTrigger className=" w-full bg-primary hover:bg-primary/80 py-2 px-4 rounded text-white flex-center gap-2 duration-200 focus:ring ring-ring ring-offset-2">Ver Gráfica linear</DialogTrigger>

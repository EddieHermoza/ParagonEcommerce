        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Line
              type="monotone"
              dataKey="compras"
              stroke={chartConfig.compras.color}
              strokeWidth={2}
              dot={false}
            />
          </LineChart>
...
export default function LinearChart({ chartData,ticker }: InteractiveStockChartProps) {
  ...
  return (
    ...
    {isMobile ? (
    <Dialog>
      <DialogTrigger className=" w-full p-2 rounded btn-primary ">Ver Gráfica linear</DialogTrigger>
      <DialogContent className="left-0 top-0 translate-x-0 translate-y-0 bg-black w-full max-w-[100vw] max-h-[100vh] h-full place-items-stretch border-none p-0">

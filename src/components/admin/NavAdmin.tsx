...
export default function NavAdmin() {
	...
	return (
		<nav className="h-full flex py-4 px-2 max-xl:hidden">
			<ul className="w-full flex flex-col gap-3 items-center text-sm overflow-y-auto">
								...
								<Tooltip>
									<TooltipTrigger asChild>
										<Link
											...
											className={`w-full rounded h-full flex-center duration-200 tracking-wide p-4 gap-2 ${activeLink === link.href

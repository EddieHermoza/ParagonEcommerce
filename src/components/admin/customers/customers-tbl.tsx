				...
				<table className="table-auto text-center w-full">
					<thead className=" border-b-primary border-b relative text-sm lg:text-base">
						<tr className="h-16">
							...
							<td className=" ">
								<button onClick={() => handleSort('lastName')} className='flex-center gap-2 mx-auto active:bg-accent hover:bg-hover p-2 rounded'>
									<HiOutlineArrowsUpDown />
									Apellidos
								</button>
							</td>
								...
								<td className="rounded-r-lg space-x-2 ">
									<Popover>
										...
										<PopoverContent align="end" className="flex flex-col items-start text-sm w-auto " sideOffset={6}>
											...
											<Link href={`/admin/products/edit/${customer.id}`} className="flex items-center gap-2 hover:bg-accent w-full rounded-sm px-3 py-2">

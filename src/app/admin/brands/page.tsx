import { BrandsTbl, ProvidersTbl } from "@/components/admin";
	...
	return (
		<>
			<section className="w-full flex items-end justify-between max-sm:flex-col-reverse gap-3">
				...
				<Button asChild>
					<Link href={"/admin/brands/create"} className="max-sm:w-full flex gap-2 ">
						<IoAddCircleOutline size={22} /> Agregar Marca
					</Link>
				</Button>
